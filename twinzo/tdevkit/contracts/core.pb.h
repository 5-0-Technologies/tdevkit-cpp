...
class SensorContract final :
 ...
 public:
  ...
  // .SensorDataContract SensorData = 11;
  bool has_sensordata() const;
  private:
  bool _internal_has_sensordata() const;
  public:
  void clear_sensordata();
  const ::SensorDataContract& sensordata() const;
  PROTOBUF_NODISCARD ::SensorDataContract* release_sensordata();
  ::SensorDataContract* mutable_sensordata();
  void set_allocated_sensordata(::SensorDataContract* sensordata);
  private:
  const ::SensorDataContract& _internal_sensordata() const;
  ::SensorDataContract* _internal_mutable_sensordata();
  public:
  void unsafe_arena_set_allocated_sensordata(
      ::SensorDataContract* sensordata);
  ::SensorDataContract* unsafe_arena_release_sensordata();
 ...
 private:
  ...
  struct Impl_ {
    ...
    ::PROTOBUF_NAMESPACE_ID::internal::ArenaStringPtr password_;
    ::SectorContract* sector_;
    ::SensorDataContract* sensordata_;
    ::AreaContract* area_;
    int32_t id_;
    float x_;
    float y_;
...
// string Max = 6;
inline void BeaconContract::clear_max() {
  _impl_.max_.ClearToEmpty();
}
inline const std::string& BeaconContract::max() const {
  // @@protoc_insertion_point(field_get:BeaconContract.Max)
  return _internal_max();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void BeaconContract::set_max(ArgT0&& arg0, ArgT... args) {
 
 _impl_.max_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:BeaconContract.Max)
}
inline std::string* BeaconContract::mutable_max() {
  std::string* _s = _internal_mutable_max();
  // @@protoc_insertion_point(field_mutable:BeaconContract.Max)
  return _s;
}
inline const std::string& BeaconContract::_internal_max() const {
  return _impl_.max_.Get();
}
inline void BeaconContract::_internal_set_max(const std::string& value) {
  
  _impl_.max_.Set(value, GetArenaForAllocation());
}
inline std::string* BeaconContract::_internal_mutable_max() {
  
  return _impl_.max_.Mutable(GetArenaForAllocation());
}
inline std::string* BeaconContract::release_max() {
  // @@protoc_insertion_point(field_release:BeaconContract.Max)
  return _impl_.max_.Release();
}
inline void BeaconContract::set_allocated_max(std::string* max) {
  if (max != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:BeaconContract.Max)
}
...
// string Max = 4;
inline void SensorContract::clear_max() {
  _impl_.max_.ClearToEmpty();
}
inline const std::string& SensorContract::max() const {
  // @@protoc_insertion_point(field_get:SensorContract.Max)
  return _internal_max();
}
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void SensorContract::set_max(ArgT0&& arg0, ArgT... args) {
 
 _impl_.max_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
  // @@protoc_insertion_point(field_set:SensorContract.Max)
}
inline std::string* SensorContract::mutable_max() {
  std::string* _s = _internal_mutable_max();
  // @@protoc_insertion_point(field_mutable:SensorContract.Max)
  return _s;
}
inline const std::string& SensorContract::_internal_max() const {
  return _impl_.max_.Get();
}
inline void SensorContract::_internal_set_max(const std::string& value) {
  
  _impl_.max_.Set(value, GetArenaForAllocation());
}
inline std::string* SensorContract::_internal_mutable_max() {
  
  return _impl_.max_.Mutable(GetArenaForAllocation());
}
inline std::string* SensorContract::release_max() {
  // @@protoc_insertion_point(field_release:SensorContract.Max)
  return _impl_.max_.Release();
}
inline void SensorContract::set_allocated_max(std::string* max) {
  if (max != nullptr) {
...
#endif // PROTOBUF_FORCE_COPY_DEFAULT_STRING
  // @@protoc_insertion_point(field_set_allocated:SensorContract.Max)
}
...
// .SensorDataContract SensorData = 11;
inline bool SensorContract::_internal_has_sensordata() const {
  return this != internal_default_instance() && _impl_.sensordata_ != nullptr;
}
inline bool SensorContract::has_sensordata() const {
  return _internal_has_sensordata();
}
inline void SensorContract::clear_sensordata() {
  if (GetArenaForAllocation() == nullptr && _impl_.sensordata_ != nullptr) {
    delete _impl_.sensordata_;
  }
  _impl_.sensordata_ = nullptr;
}
inline const ::SensorDataContract& SensorContract::_internal_sensordata() const {
  const ::SensorDataContract* p = _impl_.sensordata_;
  return p != nullptr ? *p : reinterpret_cast<const ::SensorDataContract&>(
      ::_SensorDataContract_default_instance_);
}
inline const ::SensorDataContract& SensorContract::sensordata() const {
  // @@protoc_insertion_point(field_get:SensorContract.SensorData)
  return _internal_sensordata();
}
inline void SensorContract::unsafe_arena_set_allocated_sensordata(
    ::SensorDataContract* sensordata) {
  if (GetArenaForAllocation() == nullptr) {
    delete reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(_impl_.sensordata_);
  }
  _impl_.sensordata_ = sensordata;
  if (sensordata) {
    
  } else {
    
  }
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:SensorContract.SensorData)
}
inline ::SensorDataContract* SensorContract::release_sensordata() {
  
  ::SensorDataContract* temp = _impl_.sensordata_;
  _impl_.sensordata_ = nullptr;
#ifdef PROTOBUF_FORCE_COPY_IN_RELEASE
  auto* old =  reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(temp);
  temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
...
inline ::SensorDataContract* SensorContract::unsafe_arena_release_sensordata() {
  // @@protoc_insertion_point(field_release:SensorContract.SensorData)
  
  ::SensorDataContract* temp = _impl_.sensordata_;
  _impl_.sensordata_ = nullptr;
  return temp;
}
inline ::SensorDataContract* SensorContract::_internal_mutable_sensordata() {
  
  if (_impl_.sensordata_ == nullptr) {
    auto* p = CreateMaybeMessage<::SensorDataContract>(GetArenaForAllocation());
    _impl_.sensordata_ = p;
  }
  return _impl_.sensordata_;
}
inline ::SensorDataContract* SensorContract::mutable_sensordata() {
  ::SensorDataContract* _msg = _internal_mutable_sensordata();
  // @@protoc_insertion_point(field_mutable:SensorContract.SensorData)
  return _msg;
}
inline void SensorContract::set_allocated_sensordata(::SensorDataContract* sensordata) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArenaForAllocation();
  if (message_arena == nullptr) {
    delete _impl_.sensordata_;
  }
  if (sensordata) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
        ::PROTOBUF_NAMESPACE_ID::Arena::InternalGetOwningArena(sensordata);
    if (message_arena != submessage_arena) {
      sensordata = ::PROTOBUF_NAMESPACE_ID::internal::GetOwnedMessage(
          message_arena, sensordata, submessage_arena);
    }
  ...
  _impl_.sensordata_ = sensordata;
  // @@protoc_insertion_point(field_set_allocated:SensorContract.SensorData)
}
